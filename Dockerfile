...
COPY content_service/requirements.txt /build/content_service/requirements.txt
...
RUN python -m venv /opt/venv \
    ...
    && /opt/venv/bin/pip install --no-cache-dir --timeout 120 --retries 10 -r /build/content_service/requirements.txt
